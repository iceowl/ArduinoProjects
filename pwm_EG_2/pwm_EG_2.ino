...
void loop() {
 ...
 // OCR2B = (int)waveformsTable[WAVE1][i]; //PIN 3
 // OCR2A = (int)waveformsTable[WAVE0][i]; //PIN 11
  analogWrite(PWMTIMER2_B,waveformsTable[WAVE2][i]);
  analogWrite(PWMTIMER2_A,waveformsTable[WAVE0][i++]);
